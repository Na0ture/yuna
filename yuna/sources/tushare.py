...
class TuShareSource(SourceSingleton):
    ...
    def tushare_to_truck(cls, stock_name, from_query_date, to_query_date, stocks_basics):
        ...
        :param stock_name: 股票名字，例如'000333'
        :param from_query_date: 起始日期，例如'2016-01-01'
        :param to_query_date: 终止日期，例如'2016-02-02'
        :param stocks_basics: 基本面数据，具体详情访问http://tushare.org/fundamental.html#id4
        :return: 装车，准备送往数据库
        """
        truck = Truck()
        pandas_data = ts.get_k_data(stock_name, start=from_query_date, end=to_query_date)
